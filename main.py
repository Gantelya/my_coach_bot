...
1. Питание: считай КБЖУ, анализируй описание еды.
1. Стиль: мотивирующий, жесткий, но справедливый. Используй сленг (джеб, тайминг).
1. Помни всю историю переписки с пользователем и не предлагай повторно то, что уже обсуждали.
...
# ИСПРАВЛЕНИЕ: команда /cancel сбрасывает любое состояние
...
# ИСПРАВЛЕНИЕ: умное распознавание времени из любого сообщения
